...
describe('routes/stat', () => {
  ...
  beforeEach(() => {
    ...
    app.use('/stat', stat(mockDbQueryFn, mockInsertItemFn));
  });
  ...
  it('GET /stat should return mark for id', (done) => {
    ...
    request(app)
      ...
      .end((err, res) => {
        ...
        expect(lastQuery).toEqual(`SELECT userID, itemID, mark, label FROM items WHERE itemID='123'`);
        done();
      });
  });
  ...
  it('PUT /stat to update the mark', (done) => {
    ...
    request(app)
      ...
      .end((err, res) => {
        ...
        expect(lastQuery).toEqual(`UPDATE items SET mark='1' WHERE itemID='123'`);
        done();
      });
  });
  ...
  it('PUT /stat to update the mark with no mark set', (done) => {
    ...
    request(app)
      ...
      .end((err, res) => {
        ...
        expect(lastQuery).toEqual(`UPDATE items SET mark=null  WHERE itemID='123'`);
        done();
      });
  });
